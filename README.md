...
👊AutoManage **是一款自动配置管理工具**  📝[English Document](https://github.com/shmilylty/OneForAll/tree/master/docs/en-us/README.md)

![Example](./docs/usage_example.svg)

## 🚀上手指南

📢 请务必花一点时间阅读此文档，有助于你快速熟悉AutoManage！
...
项目地址：https://github.com/ClshNuer/AutoManage
